...
the following to caldulate prediction Y for movie i
...
where $\theta_{g,i}$ is 1 if the movie i is associated with genre g and 0 otherwise.
...
My final result is in the table

| Model # | Description     | RMSE      | 
|:--------|:----------------|:---------:|
| 5       | Movie/User/Genre Bias | 0.8647045 | 

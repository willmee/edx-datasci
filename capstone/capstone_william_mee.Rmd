...
| Matrix | Dimension (rowsxcolumns i.e. usersxmovies)     | Sparcity (NA ratio) | 
|:--------|:---------------------------------------------:|:-------------------:|
...
I used the following simple function to determine matrix __sparcity__ (ratio of
NA entries)
...
## Recommenderlab
Reccomenderlab is an R package for evaluating recommendation systems which implements several
different algorithms. It uses sparse matrix representation. 
...
and 90 minutes.
2. The recommendations produced NA entries for some user/movie entries which were in the test matrix
